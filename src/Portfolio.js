...
class ProjectInfo extends Component {
	...
	render() {
		...
		return (
			<Element name="info">
			<div className="Info">
				<h1><Button class="btn btn-danger" onClick={() => this.props.close()}>x</Button> {this.props.value.name}</h1>
				<img
					width="450"
					height="325"
					src={this.props.value.image}
...
class About extends Component {
	...
	render() {
		return (
			<div className="About">
				<h1>About</h1>
				<p>asdfajsaskdfljaskdjfaklsjfdklasdkljf</p>
			</div>
		);
	}
}
			...
			projects: [
				{
					...
					description: "This demo features a model of a bridge with various spinning coins surrouding it corresponding to sensors on a physical lego bridge. Looking at these coins displays the sensor's information. This project was displayed at VMWorld 2017 in Las Vegas.",
				...
				},
				{
					...
					image: 'http://ryley.io/img/portfolio/cake.png',
